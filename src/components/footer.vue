    ...
    >
      <div class="lg:w-1/3">
        ...
        >
          ...
          <span class="self-center text-2xl font-semibold"> 品牌 </span>
        </a>
      </div>
      <div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
        <div class="space-y-3">
          ...
          <ul class="space-y-1">
            <li>
              <a rel="noopener noreferrer" href="#"> 特征 </a>
            </li>
            <li>
              <a rel="noopener noreferrer" href="#"> 集成 </a>
            </li>
            <li>
              <a rel="noopener noreferrer" href="#"> 价钱 </a>
            </li>
            <li>
              <a rel="noopener noreferrer" href="#"> 常问问题 </a>
            </li>
          </ul>
        </div>
        <div class="space-y-3">
          ...
          <ul class="space-y-1">
            <li>
              <a rel="noopener noreferrer" href="#"> 隐私 </a>
            </li>
            <li>
              <a rel="noopener noreferrer" href="#"> 服务条款 </a>
            </li>
          </ul>
        </div>
        <div class="space-y-3">
          <h3 class="uppercase dark:text-gray-50">开发商</h3>
          <ul class="space-y-1">
            <li>
              <a rel="noopener noreferrer" href="#"> 公共API </a>
            </li>
            <li>
              <a rel="noopener noreferrer" href="#"> 文档 </a>
            </li>
            <li>
              <a rel="noopener noreferrer" href="#"> 指南 </a>
            </li>
          </ul>
        </div>
        <div class="space-y-3">
          <div class="uppercase dark:text-gray-50">社交媒体</div>
          <div class="flex justify-start space-x-3">
            ...
            <a rel="noopener noreferrer" href="#" title="推特" class="flex items-center p-1">
              <svg
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                class="w-5 h-5 fill-current"
